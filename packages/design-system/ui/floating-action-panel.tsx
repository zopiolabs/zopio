...
export {
  FloatingActionPanelRoot as Root,
  FloatingActionPanelTrigger as Trigger,
  FloatingActionPanelContent as Content,
  FloatingActionPanelButton as Button,
  FloatingActionPanelForm as Form,
  FloatingActionPanelTextarea as Textarea,
};
