...
const Anchor = ({
  ...
  return (
    ...
    >
      <a href={`#${anchor}`} onClick={copyToClipboard} className="inline-flex">
        <LinkIcon className="hover:text-gray-400 text-gray-600" />
      </a>
    </div>
  );
};
  ...
  return (
    <>
      <Comp
        ...
        {...props}
        className={cn(
          anchor && 'flex scroll-m-20 items-center gap-1',
