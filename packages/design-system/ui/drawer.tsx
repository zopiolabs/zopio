...
const Drawer: React.FC<DrawerProps> = (props) =>
  React.createElement(DrawerPrimitive.Root as any, {
    "data-slot": "drawer",
    ...props,
  });
...
const DrawerTrigger: React.FC<DrawerTriggerProps> = (props) =>
  React.createElement(DrawerPrimitive.Trigger as any, {
...
const DrawerPortal: React.FC<DrawerPortalProps> = (props) =>
  React.createElement(DrawerPrimitive.Portal as any, {
...
const DrawerClose: React.FC<DrawerCloseProps> = (props) =>
  React.createElement(DrawerPrimitive.Close as any, {
...
const DrawerOverlay: React.FC<DrawerOverlayProps> = ({ className, ...props }) =>
  React.createElement(DrawerPrimitive.Overlay as any, {
...
const DrawerTitle: React.FC<DrawerTitleProps> = ({ className, ...props }) =>
  React.createElement(DrawerPrimitive.Title as any, {
...
const DrawerDescription: React.FC<DrawerDescriptionProps> = ({
  ...
  React.createElement(DrawerPrimitive.Description as any, {
