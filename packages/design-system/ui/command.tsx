...
>(({ className, ...props }, ref) => {
  // @ts-expect-error - CommandPrimitive has JSX compatibility issues with React 19.1.0
...
const CommandDialog: React.FC<DialogProps> = ({
  ...
  return (
    // @ts-expect-error - Dialog has JSX compatibility issues with React 19.1.0
    React.createElement(
      Dialog as any,
      props,
      React.createElement(
        ...
        React.createElement(
          DialogHeader as any,
          null,
          // @ts-expect-error - DialogTitle has JSX compatibility issues with React 19.1.0
          React.createElement(DialogTitle as any, null, title),
          // @ts-expect-error - DialogDescription has JSX compatibility issues with React 19.1.0
...
const CommandInput = ({
  ...
  return React.createElement(
    ...
    // @ts-expect-error - CommandPrimitive.Input has JSX compatibility issues with React 19.1.0
...
function CommandList({
  ...
  // @ts-expect-error - CommandPrimitive.List has JSX compatibility issues with React 19.1.0
...
function CommandEmpty({ ...props }: React.HTMLAttributes<HTMLDivElement>) {
  // @ts-expect-error - CommandPrimitive.Empty has JSX compatibility issues with React 19.1.0
...
function CommandGroup({
  ...
  // @ts-expect-error - CommandPrimitive.Group has JSX compatibility issues with React 19.1.0
...
function CommandSeparator({
  ...
  // @ts-expect-error - CommandPrimitive.Separator has JSX compatibility issues with React 19.1.0
...
function CommandItem({
  ...
  // @ts-expect-error - CommandPrimitive.Item has JSX compatibility issues with React 19.1.0
