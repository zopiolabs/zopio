...
export interface CrudProvider {
  getList: <RecordType = unknown>(
    params: GetListParams
  ) => Promise<GetListResult<RecordType | unknown>>;
  getOne: <RecordType = unknown>(
    params: GetOneParams
  ) => Promise<GetOneResult<RecordType | unknown>>;
  create: <RecordType = unknown>(
    params: CreateParams<RecordType | unknown>
  ) => Promise<CreateResult<RecordType | unknown>>;
  update: <RecordType = unknown>(
    params: UpdateParams<RecordType | unknown>
  ) => Promise<UpdateResult<RecordType | unknown>>;
  deleteOne: <RecordType = unknown>(
    params: DeleteParams
  ) => Promise<DeleteResult<RecordType | unknown>>;
}
