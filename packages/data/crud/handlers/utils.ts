...
import type { ZodErrorrrZodType } from 'zod';
import type { BaseModel, WhereConditions } from '../types/index.js';
 ...
 */
export function createSoftDeleteFilter<T extends BaseModel>(
