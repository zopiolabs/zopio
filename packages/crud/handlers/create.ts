...
import type { CreateHandlerOptions, BaseModel, DatabaseModel } from '../types';

/**
 * Creates a handler for POST requests to create new records
 * @template T - The type of the data model
 * @template R - The type of the returned data (defaults to T)
 * @param options - Configuration options for the create handler
