...
To those that use Cursor, Windsurf or GitHub Copilot - You can customize the AI agent rules by updating the respected file listed below. For context, each chat response will read through the file and repspond with a more currated response based on your rules. It is important to

<Warning>Keep your instructions short and precise. Poor instructions can degrade Cursor, Windsurf and Copilot quality and performance.</Warning>
...
Windsurf is a lightweight local AI code editor designed for TypeScript and Next.js projects. Unlike cloud-based AI tools, it runs directly within your project directory and provides fast, contextual assistance.

Update the `.windsurfrc` file to customize the AI agent to your project needs. These rules can be updated at any time and will better help you over time.

You can learn more and get started with the official documentation: [Windsurf Documentation](https://github.com/staight/windsurf)

<Note>Although Windsurf uses local context for better accuracy, always review and verify AI-generated code suggestions to ensure correctness. </Note>
