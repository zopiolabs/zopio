---
title: Components
description: Zopio offers a default component library by shadcn/ui
---
...
```sh Terminal
npx shadcn@latest add select -c packages/core/design-system
```
...
```sh Terminal
npx shadcn@latest add --all --overwrite -c packages/core/design-system
```
