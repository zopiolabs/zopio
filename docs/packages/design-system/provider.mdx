...
This provider is already added to the default apps. If you want to add a new app, make sure you add it to your root layout along with [fonts](/packages/core/design-system/typography) and global CSS, like so:
