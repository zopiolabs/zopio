---
title: Documentation
description: How the documentation is configured in Zopio.
---
...
Zopio uses [Mintlify](https://mintlify.com) to generate beautiful docs. Each page is a `.mdx` file, written in Markdown, with built-in UI components and API playground.
