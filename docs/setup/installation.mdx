...
For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://docs.Zopio.com/packages/database#default-configuration).

## CMS

You will need to setup the CMS. Follow the instructions [here](/features/cms), but the summary is:

1. Fork the [`basehub/Zopio`](https://basehub.com/basehub/Zopio?fork=1) template
