...
We've tested and confirmed that Zopio works on the following combinations of operating systems, Node.js versions and Zopio versions:

| Operating system | Zopio version | Node.js version | Notes |
| ---------------- | ----------------- | --------------- | ----- |
| macOS Sequoia 15.0.1 (24A348) | 1.0.0 | 20.12.2 |  |
| Ubuntu 24.04 Arm64 | 1.0.0 | 20.18.0 |  |
| Fedora, Release 41 | 1.0.0 | 22.11.0 |  |
| Windows 11 Pro 24H2 (26100.2033) | 1.0.0 | 20.18.0 | Turborepo only supports specific architectures. `windows ia32` is not supported. |
