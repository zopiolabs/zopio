...
While Zopio does not come with link tracking and analytics out of the box, you can easily add it to your app with [Dub](https://dub.co/).
...
<Card title="Documentation" icon="book" href="https://dub.co/docs/api-reference/introduction" horizontal>
