export const VercelButton = () => {
  ...
  url.searchParams.set('demo-title', 'Zopio');
  url.searchParams.set('demo-url', 'https://www.Zopio.com/');
  ...
  url.searchParams.set('envLink', 'https://docs.Zopio.com/setup#accounts');
  url.searchParams.set('from', 'templates');
  url.searchParams.set('project-name', 'Zopio');
  url.searchParams.set('repository-name', 'Zopio');
  url.searchParams.set('repository-url', 'https://github.com/zopiolabs/zopio');
